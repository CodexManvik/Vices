...
ADMIN_PASSWORD = os.getenv("ADMIN_PASSWORD", "vices_admin_password")
ADMIN_TOKEN_SECRET = os.getenv("ADMIN_TOKEN_SECRET", "vices_secret_token")
REQUEST_STORAGE_PATH = str(DATA_DIR / "access_requests.json")
APPROVED_TOKENS_PATH = str(DATA_DIR / "approved_tokens.json")
MASTER_TOKEN = os.getenv("MASTER_TOKEN", "vices_master_dev_token_2026")
